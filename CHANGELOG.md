...
- Added a `WP_NATIVE_APIS_ENABLE_URL_DEFAULTS` opt-out for public URL-in-text native defaults.
- Added a `WP_NATIVE_APIS_ENABLE_HTML_DEFAULTS` opt-out for public HTML native defaults, matching the XML component controls.
- Expanded `WP_NATIVE_APIS_ENABLE_XML_DEFAULTS` falsey environment values to match HTML native-default controls.
